...
(function () {
  ...
  var CSS = [
    ...
    "[data-theme='kum']{--bg:#F3EAD6;--bg-soft:#F8F1E2;--teal:#A9772E;--teal-deep:#6E4B18;--teal-soft:rgba(169,119,46,.14);--cat-accent:#A9772E;--gri-bg:#F3EAD6;--gri-surface:#FAF3E4;--gri-surface-2:#F3EAD4;--gri-accent:#A9772E;--gri-accent-soft:#F3E7CD;--gri-accent-deep:#6E4B18}",
