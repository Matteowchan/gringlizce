...
(function () {
  ...
  function runMT(lang) {
    ...
    function applier() { _loadScript("assets/gri-mt.js?v=5", function () { try { window.GriMT.apply(getLang()); } catch (e) {} }); }
    ...
    function withExtra(next) { _loadScript("assets/gri-i18n-extra.js?v=5", next); }
