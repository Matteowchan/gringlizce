...
(function () {
  ...
  var CSS = [
    ...
    ".gri-dd-mega .gri-dd-menu{grid-template-columns:repeat(3,minmax(170px,1fr));gap:6px 20px;min-width:580px;max-width:min(94vw,780px);max-height:calc(100vh - 88px);overflow-y:auto;align-content:start;padding:16px 18px}",
    ".gri-dd-mega .gri-grp{padding:2px 2px 12px}.gri-dd-mega .gri-grp+.gri-grp{border-top:none;margin-top:0}",
    ".gri-dd-mega .gri-dd-menu a{padding:6px 10px;font-size:13px;border-radius:9px;transition:background .12s ease,color .12s ease,padding-left .14s ease}",
    ".gri-dd-mega .gri-dd-menu a:hover{padding-left:15px}",
    ".gri-dd-mega .gri-grp>.gh{display:block;padding:6px 9px 7px;margin-bottom:5px;font-family:Inter,sans-serif;font-size:11px;font-weight:800;letter-spacing:.09em;text-transform:uppercase;color:var(--gri-accent);border-bottom:1px solid var(--gri-line-soft)}.gri-dd-mega .gri-sub a{padding-left:11px}",
    ...
    ".gri-dd.gri-dd-mega.open>.gri-dd-menu,.gri-dd.gri-dd-cols2.open>.gri-dd-menu{display:grid}",
    ...
    ".gri-mgrp-h{font-family:Inter,sans-serif;font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:var(--gri-accent);padding:18px 2px 6px;border-bottom:1px solid var(--gri-line-soft);margin-bottom:2px}",
  ...
  var THEMES = [
    ...
    { t: "tiffany", name: "Tiffany", dot: "#0ABAB5" },
    { t: "mocha", name: "Mocha", dot: "#A47864" }, { t: "visne", name: "Vişne", dot: "#C8303E" },
    { t: "persimmon", name: "Persimmon", dot: "#D2662F" }, { t: "wasabi", name: "Wasabi", dot: "#8DA01F" },
    { t: "dark", name: "Gece", dot: "#201C17" }
  ];
  function themeOptsHtml(){ return "<div class='gri-thgrid'>"+THEMES.map(function(x){ return "<button class='gri-th-opt' data-t='"+x.t+"' title='"+x.name+"' aria-label='"+x.name+"'><span class='dot' style='background:"+x.dot+"'></span>"+x.name+"</button>"; }).join("")+"</div>"; }
