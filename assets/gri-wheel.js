...
(function(){
  ...
  function css(){
    ...
    s.textContent=[
      ...
      '.gwo-wheel::before{content:"";position:absolute;inset:24px;border-radius:50%;border:2px dashed var(--wo-gold);opacity:.30;pointer-events:none;}',
      '.gwo-wheel::after{content:"";position:absolute;left:50%;top:50%;width:13px;height:13px;margin:-6.5px 0 0 -6.5px;border-radius:50%;background:var(--wo-gold);opacity:.55;box-shadow:0 0 0 5px rgba(199,154,58,.14);pointer-events:none;}',
