...
(function(){
  ...
  function css(){
    ...
    s.textContent=[
      ...
      '.gwo-wheel{position:absolute;inset:0;border-radius:50%;background:radial-gradient(circle at 50% 38%,#fffefb,#f4ead2);border:3px solid var(--wo-line);box-shadow:0 12px 30px rgba(43,33,24,.16),inset 0 2px 8px rgba(255,255,255,.65);}',
      ':root[data-theme="dark"] .gwo-wheel{background:radial-gradient(circle at 50% 38%,#352f25,#221e17);box-shadow:0 12px 30px rgba(0,0,0,.42),inset 0 2px 8px rgba(255,255,255,.05);}',
      '.gwo-wheel::before{content:"";position:absolute;inset:20px;border-radius:50%;border:1.5px solid var(--wo-line);opacity:.5;pointer-events:none;}',
      '.gwo-svg{position:absolute;inset:0;width:100%;height:100%;pointer-events:none;filter:drop-shadow(0 2px 6px rgba(43,33,24,.20));}',
      '.gwo-k{position:absolute;width:56px;height:56px;margin:-28px 0 0 -28px;border-radius:50%;background:linear-gradient(180deg,#ffffff,#fbf4e2);border:2px solid var(--wo-line);color:var(--wo-ink);font-weight:800;font-size:26px;text-transform:uppercase;display:flex;align-items:center;justify-content:center;transition:transform .14s cubic-bezier(.34,1.56,.64,1),background .14s,border-color .14s,box-shadow .14s;user-select:none;box-shadow:0 3px 9px rgba(43,33,24,.15),inset 0 1px 0 rgba(255,255,255,.85);}',
      ':root[data-theme="dark"] .gwo-k{background:linear-gradient(180deg,#3c352a,#2b261e);box-shadow:0 3px 9px rgba(0,0,0,.35),inset 0 1px 0 rgba(255,255,255,.06);}',
      '.gwo-k:hover{border-color:var(--wo-gold);}',
      '.gwo-k.sel{background:var(--wo-gold);border-color:var(--wo-gold);color:#fff;transform:scale(1.24);box-shadow:0 8px 20px rgba(199,154,58,.42);}',
      ...
      '.gwo-mean{position:fixed;left:50%;bottom:24%;transform:translateX(-50%) translateY(10px);background:#241f18;color:#fff;box-shadow:0 6px 20px rgba(0,0,0,.35);padding:9px 18px;border-radius:22px;font-weight:700;font-size:.92rem;opacity:0;pointer-events:none;transition:opacity .25s,transform .25s;z-index:60;}',
