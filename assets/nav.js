...
(function () {
  ...
  var CSS = [
    ...
    ".gri-dd-mega .gri-dd-menu{grid-template-columns:repeat(3,minmax(188px,1fr));gap:10px;min-width:610px;max-width:min(94vw,770px);max-height:calc(100vh - 88px);overflow-y:auto;align-content:start;padding:14px}",
    ".gri-dd-mega .gri-grp{padding:10px 10px 6px;background:var(--gri-surface-2);border:1px solid var(--gri-line-soft);border-radius:14px}.gri-dd-mega .gri-grp+.gri-grp{border-top:1px solid var(--gri-line-soft);margin-top:0}",
