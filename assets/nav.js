...
(function () {
  ...
  var CSS = [
    ...
    ".gri-dd-mega .gri-dd-menu{grid-template-columns:repeat(3,minmax(158px,1fr));gap:0 6px;min-width:540px;max-width:min(92vw,740px);max-height:calc(100vh - 88px);overflow-y:auto;align-content:start}",
